...
| `service.server.ports.metrics-api.enabled`         | Make immich to expose it's metrics endpoints                                                                                                  | `false`                                                                                 |
| `service.server.ports.metrics-ms.enabled`          | Make immich to expose it's metrics endpoints                                                                                                  | `false`                                                                                 |
